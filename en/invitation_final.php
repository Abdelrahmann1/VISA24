                        ...
                        <div class="hs-1">
                            ...
                            <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li checked><a  class="dropdown-item" data-img="../img/flag.jpg"><img
                                                    src="../img/flag.jpg" alt=""> English</a></li>
                                                    <li checked><a  class="dropdown-item" data-img="../img/flag.jpg"><img
                                                    src="../img/flag.jpg" alt=""> sd</a></li>
                                    </ul>
                                </div>
                        </div>
                ...
                <div class="section">
                    ...
                    <div class="section-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <label>In order to obtain a Russian Visa foreign citizens are also required to get a Medical
                    ...
                    <div class="total-amount">
                        <div class="t-fee">
                            <div class="amount-box amount-boxs">
                                <span id="totalAmount1" class="totalAmount">Total Amount: 150 USD</span>
                            </div>
                            <div class=" amount-box amount-boxabs">
                                <span id="totalAmount2" class="totalAmount">Total Amount: 150 USD</span>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 offset-lg-1">
                        <div class="ft-contact">
                            <h6>Contact Us</h6>
                            <ul>
                                <li>Tel. : +7 968 ​​01 000 24 <a href="https://wa.me/+7 915 304-42-42" target="_blank"
